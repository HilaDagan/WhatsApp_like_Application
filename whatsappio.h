...
static const char*__attribute__((unused))  S_C_EXIT = "a\n";
//char* P_EXIT_FROM_CLIENT = "b";
static const char* __attribute__((unused)) S_C_CONNECT_SUCCESS = "0\n";;
static const char* __attribute__((unused)) S_C_CONNECT_FAIL = "1\n";
static const char* __attribute__((unused))  S_C_CONNECT_DUP = "2\n";

static const char* __attribute__((unused)) S_C_CREATE_GROUP_SUCCESS = "0\n";
static const char* __attribute__((unused)) S_C_CREATE_GROUP_FAIL = "1\n";

static const char* __attribute__((unused)) S_C_WHO_SUCCESS = "0\n";
static const char* __attribute__((unused)) S_C_WHO_FAIL = "1\n";

static const char* __attribute__((unused)) S_C_SEND_SUCCESS = "0\n";
static const char* __attribute__((unused)) S_C_SEND_FAIL = "1\n";
...
bool isLettersOrDigits(const std::string &input);
